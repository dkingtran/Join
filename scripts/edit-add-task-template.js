        ...
        <div class="section-task-left w-full max-w-50">
          ...
          <div class="date-task">
            ...
            <div class="error-container" id="date-error-border">
              <div id="error-info" class="error-text d-none">This fields is required or the date in the past</div>
            </div>
          </div>
        </div>
...
<div class="assigned-to-container">
  ...
  <input class="add-subtask-input input-bundle font-bundle" type="text" placeholder="Add new subtask" readonly>
  <span id="open-subtask" class="icon plus"
    ...
    <img src="assets/img/icons/add_task/add.svg" alt="Plus Icon">
            ...
            <div id="subtask-active" class="subtask-input-box input-bundle max-w-440 d-none">
              <input class="input-second font-bundle" type="text" id="subtask-input-second" placeholder="Add new subtask">
              <div class="icon-subtask-container display-standard">
                ...
                <span id="confirm-subtask" class="icon confirm" onclick="confirmSubtaskInputOverlay()">
                  <img class="icon-task" src="assets/img/icons/add_task/check_noir.svg" alt="Confirm Icon">
                </span>
              </div>
            </div>
          </div>
...
function getSubtaskTemplateOverlay(text) {
  ...
  return '<div class="subtask-text-box flex justify-between ">'
