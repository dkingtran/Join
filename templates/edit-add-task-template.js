        ...
        <div class="form-scroll">
            <div class="add-task-container edit-add-task-container w-full flex">
                ...
                <div class="section-task-right w-full max-w-50">
                    ...
                    <div class="priority-btn btn-prio flex justify-start max-w-440">
                        ...
                        <button id="medium" type="button"
                            class="priority-btn medium-btn btn-prio-bundle border-radius-10px font-bundle display-standard active-yellow">
                            Medium <img id="medium-icon" src="./assets/img/icons/add_task/prio_medium_orange.svg"
                                alt="medium">
                        </button>
                        <button id="low" type="button" class="priority-btn font-bundle btn-prio-bundle border-radius-10px">
